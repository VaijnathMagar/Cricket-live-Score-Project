    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                match1.setTeamHeadling(teamsHeading);
...
//                update the match in database
    ...
    private void updateMatchInDat(Match match1) {

        Match match = this.matchRepo.findByTeamHeadling(match1.getTeamHeadling()).orElse(null);
        if(match == null){
